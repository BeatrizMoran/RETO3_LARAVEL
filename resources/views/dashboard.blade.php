            ...
            @auth
                <div class="row">
                    <div class=" welcome-message p-4 mb-4 bg-light border rounded m-4">
                        ...
                        <p class="lead">Hola, <strong>{{ auth()->user()->name }}</strong>. Es un placer tenerte con nosotros.
                        </p>
                        <hr class="my-2">
                        <p>En Killer, estamos comprometidos con la excelencia y tu crecimiento profesional. Explora, colabora y
                            crece
                            con nosotros.</p>

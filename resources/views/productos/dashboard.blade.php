        ...
        <div class="card my-4 shadow-lg">
            ...
            <div class="bg-primary bg-gradient rounded-3 shadow-lg border-radius-lg pt-4 pb-3 d-flex justify-content-between">
                    ...
                    @if(auth()->user()->hasRole('responsable') || auth()->user()->hasRole('administrativo'))
                        ...
                        <a href="{{ route('productos.create') }}" class="btn bg-success bg-gradient mb-3 mx-3"><i class="fa-solid fa-plus"></i><span class="mx-3">Añadir Producto</span></a>
                    @endif
                </div>
            </div>
                        ...
                        <tbody>
                            @forelse($productos as $producto)
                                <tr>
                                    ...
                                    <td class="p-2">{{ $producto->codigo_referencia }}</td>
                                    <td class="p-2 tex-center">{{ $producto->nombre }}</td>
                                    ...
                                    <td class="p-2">
                                        ...
                                        <button type="button" class="btn btn-danger btn-md" data-bs-toggle="modal" data-bs-target="#confirmDeleteModal_{{ $producto->id }}" data-product-id="{{ $producto->id }}">

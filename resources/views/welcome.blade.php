...
@section('content')
    <div id="carruselWelcome" class="row carousel slide d-flex justify-content-center" data-bs-ride="carousel">
        <div class="col-12">
    ...
    <div class="row bg-white opacity-75 p-4 my-4">
        <div class="col-md-7">
            ...
            <small>Si quieres saber mas sobre nuestra historia <a href="#" class="text-decoration-none">conocenos!</a>
            </small>
        </div>
        <div class="col-md-4">
